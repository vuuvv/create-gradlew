...
module.exports = class BasicGenerator extends Generator {
    ...
    const prompts = [
      {
        ...
        choices: [
          ...
          { name: 'simple module', value: 'simple-module' },
          { name: 'spring boot module', value: 'spring-boot-module' },
        ],
      },
    ];
  ...
  writing() {
    ...
    this.fs.copyTpl(this.templatePath(this.props.type), this.destinationPath('.'), context);
  }
};
